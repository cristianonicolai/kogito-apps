...
import org.kie.kogito.index.testcontainers.DataIndexMongoContainer;
...
public class DataIndexMongoResource implements TestResource {

    private static final Logger LOGGER = LoggerFactory.getLogger(DataIndexMongoResource.class);

    KogitoKafkaContainer kafka = new KogitoKafkaContainer();
    KogitoMongoDBContainer mongodb = new KogitoMongoDBContainer();
    DataIndexMongoContainer dataIndex = new DataIndexMongoContainer();
    ...
    public void start() {
        ...
        dataIndex.setMongoURL("mongodb://mongo:27017/test");
