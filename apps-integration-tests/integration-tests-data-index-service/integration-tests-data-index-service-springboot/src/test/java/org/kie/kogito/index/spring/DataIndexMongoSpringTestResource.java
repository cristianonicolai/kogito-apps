...
import org.kie.kogito.index.resources.DataIndexMongoResource;
...
public class DataIndexMongoSpringTestResource extends ConditionalSpringBootTestResource {

    public static final String KOGITO_DATA_INDEX_SERVICE_URL = "kogito.data-index-service.url";

    public DataIndexMongoSpringTestResource() {
        super(new DataIndexMongoResource());
    }

    @Override
    protected void updateContextProperty(ConfigurableApplicationContext ctx, String key, String value) {
        List<String> props = ((DataIndexMongoResource) getTestResource()).getProperties().entrySet().stream()
