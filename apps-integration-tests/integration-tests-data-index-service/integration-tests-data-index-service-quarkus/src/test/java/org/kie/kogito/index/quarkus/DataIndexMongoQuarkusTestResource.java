...
public class DataIndexMongoQuarkusTestResource extends ConditionalQuarkusTestResource {

    public static final String KOGITO_DATA_INDEX_SERVICE_URL = "kogito.data-index-service.url";

    public DataIndexMongoQuarkusTestResource() {
    ...
    public Map<String, String> start() {
        ...
        properties.putAll(((DataIndexMongoResource) getTestResource()).getProperties());
        return properties;
    }
